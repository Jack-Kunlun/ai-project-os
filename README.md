...
当前版本状态：`CONTROLLED_PRERELEASE` · `0.6.0-dev.11（受控生产预发布）`
...
正式稳定版基线：无。当前生产版本为 `v0.6.0-dev.11`；它仍是预发布，不是稳定版或 GitHub Latest。此次发布从 `.10` 按固定的 116→117 迁移路径完成，停写异地备份、迁移后预检与公网健康检查均通过。
