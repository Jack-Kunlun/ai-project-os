export type McpCapabilityErrorCode =
  ...
  | "MCP_LEGACY_CONNECTION_API_FROZEN"
  | "MCP_CONNECTION_CONFLICT"
  | "MCP_CONNECTION_DISABLED"
  | "MCP_CONNECTION_NOT_VERIFIED"
  | "MCP_CONNECTION_IN_USE"
  | "MCP_CONNECTION_LIVE_DELEGATION_DELETE_FORBIDDEN"
  | "MCP_CONNECTION_V2_ATTESTATION_DELETE_FORBIDDEN"
  | "MCP_CONNECTION_DELETE_REQUIRES_DISABLED"
  | "MCP_CONNECTION_CONFIRMATION_MISMATCH"
  | "MCP_CONNECTION_GOVERNANCE_REQUIRED"
  | "MCP_CONNECTION_PREVIEW_NOT_FOUND"
  | "MCP_CONNECTION_PREVIEW_EXPIRED"
  | "MCP_CONNECTION_PREVIEW_CONSUMED"
  | "MCP_CONNECTION_PREVIEW_MISMATCH"
  | "MCP_CONNECTION_IMPACT_CHANGED"
  ...
  | "MCP_LEGACY_PROJECT_RUNTIME_FROZEN"
  | "MCP_TOOL_REVIEW_REQUIRED"
  | "MCP_ATTESTATION_NOT_FOUND"
  | "MCP_ATTESTATION_CONFLICT"
  | "MCP_ATTESTATION_REAUTHENTICATION_REQUIRED"
  | "MCP_TOOL_REVIEW_INVALID_INPUT"
  | "MCP_TOOL_REVIEW_NOTE_UNSAFE"
  | "MCP_TOOL_REVIEW_CANDIDATE_STALE"
  | "MCP_TOOL_REVIEW_IDEMPOTENCY_CONFLICT"
  | "MCP_TOOL_REVIEW_NOT_FOUND"
  | "MCP_TOOL_REVIEW_ATTESTATION_CONFLICT"
