...
export {
  ...
  GITHUB_REQUEST_DEADLINE_SAFETY_MS,
  GITHUB_USER_AGENT,
  GitHubReadError,
...
export {
  ...
  PROJECT_GITHUB_SYNC_DEADLINE_MS,
  PROJECT_GITHUB_SYNC_SERVICE_VERSION,
  ...
  type ProjectGitHubSyncChangeView,
  type ProjectGitHubSyncEntryView,
  type ProjectGitHubSyncErrorCode,
  type PublicProjectGitHubSyncRun,
  type ProjectGitHubSyncRuntime,
