...
export const POSTGRES_GATES: readonly PostgresGateDefinition[] = Object.freeze([
  ...
  { id: "membership-application", file: "test/membership-application-postgres.test.ts", database: "ai_project_os_membership_application_test", gateEnv: "MEMBERSHIP_APPLICATION_POSTGRES_GATE", setup: "migrate" },
  { id: "account-access-lifecycle", file: "test/account-access-lifecycle-postgres.test.ts", database: "ai_project_os_account_access_lifecycle_test", gateEnv: "ACCOUNT_ACCESS_POSTGRES_GATE", setup: "migrate" },
  ...
  { id: "clean-slate-schema", file: "test/0.2x-migration-inventory-postgres.test.ts", database: "ai_project_os_ownership_inventory_test", gateEnv: "CLEAN_SLATE_SCHEMA_POSTGRES_GATE", databaseUrlEnv: "CLEAN_SLATE_SCHEMA_TEST_DATABASE_URL", setup: "migrate" },
  ...
  { id: "project-access-revocation", file: "test/project-access-revocation-postgres.test.ts", database: "ai_project_os_project_access_revocation_test", gateEnv: "PROJECT_ACCESS_REVOCATION_POSTGRES_GATE", setup: "migrate" },
  ...
  { id: "project-export-access", file: "test/project-export-access-postgres.test.ts", database: "ai_project_os_project_export_access_test", gateEnv: "PROJECT_EXPORT_ACCESS_POSTGRES_GATE", setup: "migrate" },
  ...
  { id: "team-experience", file: "test/team-experience-postgres.test.ts", database: "ai_project_os_team_experience_test", gateEnv: "TEAM_EXPERIENCE_POSTGRES_GATE", setup: "migrate" },
  ...
  { id: "account-entitlement-inventory", file: "test/account-entitlement-inventory-postgres.test.ts", database: "ai_project_os_account_entitlement_inventory_test", gateEnv: "ACCOUNT_ENTITLEMENT_INVENTORY_POSTGRES_GATE", setup: "migrate" },
  { id: "account-entitlement-upgrade", file: "test/account-entitlement-upgrade-postgres.test.ts", database: "ai_project_os_account_entitlement_upgrade_test", gateEnv: "ACCOUNT_ENTITLEMENT_UPGRADE_POSTGRES_GATE", databaseUrlEnv: "ACCOUNT_ENTITLEMENT_UPGRADE_TEST_DATABASE_URL", setup: "self" },
