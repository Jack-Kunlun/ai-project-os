...
export const SYSTEM_AUDIT_SOURCE_LABELS: Readonly<Record<SystemAuditSource, string>> = {
  ...
  gitConnectionMutation: "Git 连接治理",
  mcpConnectionMutation: "MCP 连接治理",
  mcpToolAttestation: "MCP 工具认证",
  mcpToolReview: "MCP 工具人工审核",
...
export const SYSTEM_AUDIT_ALLOWED_ACTIONS_BY_SOURCE: Readonly<Record<SystemAuditSource, readonly SystemAuditAction[]>> = {
  ...
  gitConnectionMutation: ["rotateCredential", "retrust", "retest", "disable", "enable", "delete"],
  mcpConnectionMutation: ["rotateCredential", "retrust", "rediscover", "disable", "enable", "delete"],
  mcpToolAttestation: ["attested", "revoked"],
  mcpToolReview: ["attested", "rejected", "reviewed"],
...
export const SYSTEM_AUDIT_ALLOWED_RESULTS_BY_SOURCE: Readonly<Record<SystemAuditSource, readonly SystemAuditResult[]>> = {
  ...
  gitConnectionMutation: ["pending", "applied", "disabled", "failed", "unknown"],
  mcpConnectionMutation: ["pending", "applied", "disabled", "failed", "unknown"],
  mcpToolAttestation: ["applied", "revoked"],
  mcpToolReview: ["applied", "rejected", "pending"],
