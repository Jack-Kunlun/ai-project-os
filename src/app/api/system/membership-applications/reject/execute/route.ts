...
import { executeRejectMembershipApplication } from "@/lib/membership-application-service";
...
export async function POST(request: Request) {
  try {
    ...
    const application = await executeRejectMembershipApplication({ ...input, actorId: admin.id });
