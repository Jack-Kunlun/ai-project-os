...
export const POSTGRES_GATES: readonly PostgresGateDefinition[] = Object.freeze([
  ...
  { id: "system-role-compatibility", file: "test/phase-a-schema-postgres.test.ts", database: "ai_project_os_system_role_compatibility_test", gateEnv: "SYSTEM_ROLE_COMPATIBILITY_POSTGRES_GATE", setup: "migrate" },
