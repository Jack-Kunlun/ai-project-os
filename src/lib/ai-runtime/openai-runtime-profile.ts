...
export const OPENAI_SOURCE_SUMMARY_MODEL_ID = OPENAI_AUTO_EXTRACT_MODEL_ID;
export const OPENAI_PROJECT_ANALYSIS_MODEL_ID = OPENAI_AUTO_EXTRACT_MODEL_ID;
...
export const OPENAI_SOURCE_SUMMARY_PROCESSOR_FINGERPRINT = fingerprint(
  "processor:source-summary:http-transport:v1",
);
export const OPENAI_PROJECT_ANALYSIS_PROCESSOR_FINGERPRINT = fingerprint(
  "processor:project-analysis:http-transport:v1",
);
...
export const OPENAI_SOURCE_SUMMARY_MODEL_FINGERPRINT = fingerprint(
  `model:${OPENAI_SOURCE_SUMMARY_MODEL_ID}`,
);
export const OPENAI_PROJECT_ANALYSIS_MODEL_FINGERPRINT = fingerprint(
  `model:${OPENAI_PROJECT_ANALYSIS_MODEL_ID}`,
);
...
export const OPENAI_SOURCE_SUMMARY_PROFILE_FINGERPRINT = fingerprint(
  [
...
export const OPENAI_PROJECT_ANALYSIS_PROFILE_FINGERPRINT = fingerprint(
  [
...
export function getOpenAiSourceSummaryProfile(): Readonly<OpenAiResponsesProfile> {
  return Object.freeze({
    profileVersion: OPENAI_RESPONSES_PROFILE_VERSION,
    providerFingerprint: OPENAI_RESPONSES_PROVIDER_FINGERPRINT,
...
export function getOpenAiProjectAnalysisProfile(): Readonly<OpenAiResponsesProfile> {
  return Object.freeze({
    profileVersion: OPENAI_RESPONSES_PROFILE_VERSION,
    providerFingerprint: OPENAI_RESPONSES_PROVIDER_FINGERPRINT,
