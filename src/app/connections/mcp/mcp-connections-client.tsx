...
export function McpConnectionsClient({ username, adminMode = false }: { username: string; adminMode?: boolean }) {
  ...
  return (
    <main className="min-h-screen bg-[#f5f7fb] text-slate-950">
      ...
      <AdminPageFrame active="mcp" showSidebar={adminMode}><div className="mx-auto max-w-7xl px-6 py-10 sm:px-10 lg:px-12">
...
function McpConnectionCardContent({ connection, onChanged, onRemoved, confirm }: McpConnectionCardProps & { confirm: ReturnType<typeof useAppConfirmDialog>["confirm"] }) {
  ...
  async function removeConnection() {
    ...
    } catch (cause) { setMessage(cause instanceof Error ? cause.message : "永久删除失败"); }
    finally { setPending(null); }
  }
