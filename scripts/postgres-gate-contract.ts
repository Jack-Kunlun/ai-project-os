...
export const POSTGRES_GATES: readonly PostgresGateDefinition[] = Object.freeze([
  ...
  { id: "production-upgrade-preflight", file: "test/production-upgrade-preflight-postgres.test.ts", database: "ai_project_os_production_preflight_test", gateEnv: "PRODUCTION_UPGRADE_PREFLIGHT_POSTGRES_GATE", databaseUrlEnv: "PRODUCTION_UPGRADE_PREFLIGHT_TEST_DATABASE_URL", setup: "self" },
  ...
  { id: "first-admin-onboarding", file: "test/first-admin-onboarding-postgres.test.ts", database: "ai_project_os_first_admin_onboarding_test", gateEnv: "FIRST_ADMIN_ONBOARDING_POSTGRES_GATE", setup: "migrate" },
